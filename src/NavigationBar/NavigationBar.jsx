            ...
            <div className="navbar  border-b border-success max-w-7xl mx-auto">
                <div className="navbar-start">
                    ...
                    <Link to={"/"} className="flex items-center">
                        <img
                            className="h-10"
                            src="https://raw.githubusercontent.com/ashikur-rahman-10/dummy-data-repo/main/Islam-House-Publications/logo/logo%20(1).png"
                            alt=""
                        />
                    </Link>
                </div>
                <span className="lg:hidden navbar-center">
                    <input
                        ...
                        className="px-4 py-2 focus:outline-none text-center rounded-3xl input-bordered input-success ml-3 w-36"
                    />
                </span>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        <input
                            type="text"
                            placeholder="Search by book name"
                            className="px-4 py-2 text-center focus:outline-none rounded-3xl input-bordered input-success w-80 "
                        />
                    </ul>
                </div>
